...
/*
  If you dont want to sort the vector which cost O(nlogn),
  we can get how many permutations we need at first.
  But this works only when no duplicates involved.
*/
